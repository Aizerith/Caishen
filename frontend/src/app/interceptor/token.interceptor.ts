...
import { catchError, concatMap, finalize, from, Observable, switchMap, tap, throwError } from 'rxjs';
...
export class TokenInterceptor implements HttpInterceptor {
  ...
  private isStaticAssetRequest(request: HttpRequest<any>): boolean {
    return request.url.startsWith('/assets/') || request.url.includes('/assets/');
  }
}
